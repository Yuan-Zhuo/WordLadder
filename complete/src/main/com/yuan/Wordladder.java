...
public class Wordladder {
    private static Set<String> get_dict() {
        ...
        try {
            Scanner file = new Scanner(new File("backend/src/data/dict.txt"));
    ...
    private static String display(Stack<String> path,String str1,String str2){
        if(path.isEmpty()){
            throw new WordladderException("no path");
        }else{
    ...
    public static String get_path(String str1,String str2) {
        ...
        if(dict.isEmpty())
            throw new WordladderException("dictionary error");
